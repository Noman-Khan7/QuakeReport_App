        ...
        public static ArrayList<Earthquake> extractEarthquakes() {
            ...
            try {
                ...
                for (int i=0;i<earthquakeArray.length();i++)
                {
                    ...
                    double magn = properties.getDouble("mag");
                    String laoation=properties.getString("place");
                    String time=properties.getString("time");
                    DecimalFormat formatter = new DecimalFormat("0.0");
                    String  magnitude= formatter.format(magn);
                    ...
                    Earthquake earthquake=new Earthquake(magnitude,laoation,dateToDisplay,url);
